    ...
    $('textarea.tinymce').tinymce({
        ...
        setup: function (ed) {
            ...
            ed.onInit.add(function (ed) {
				...
				AudioPlayer.jPlayer({
                    ...
                    ready: function () {
                        ...
                        $(this).jPlayer("setMedia", {
                            //m4v: "http://41.41.139.180:8080/_MediaMonitoring/SessionFiles/Mp3_all/audio23.mp4",
                            m4a: $(".MP3FilePath").val(),
							m4v: $(".MP3FilePath").val(),
							ogv: $(".MP3FilePath").val(),//.replace("mp4", "ogv"),
							webmv: $(".MP3FilePath").val(),//.replace("mp4","webm")
				...
				/* -------------- END SCRIPT FOR THE VIDEO PLAYER -------------- */
